...
import { PortfolioAllocationProps, PortfolioDataProps } from '../sections/invest/types';
import PortfolioPieChart from './PortfolioPieChart';
import PortfolioControls from '../sections/invest/PortfolioControls';
...
export const PortfolioAllocationManager = ({ user, isLoading }: PortfolioAllocationProps): React.ReactElement => {
  // Portfolio data state with default allocation
